(function(factory) {
    ...
    function(){
        ...
        //主接口
        window.laydate = function(options){
            options = options || {};
            Dates.run(options);
            return laydate;
        };
        ...
        Dates.use = function(lib, id){
            ...
            link.type = 'text/css';
            link.rel = 'stylesheet';
            link.href = '//s.ssl.qhimg.com/static/27ea59f12304c82b/laydate.css';
            id && (link.id = id);
        ...
        Dates.orien = function(obj, pos){
            var tops, rect = Dates.elem.getBoundingClientRect(),
                winWidth = window.innerWidth || window.document.documentElement.clientWidth,
                left = rect.left + (pos ? 0 : Dates.scroll(1))
            if (left + 242 < winWidth) {
